...
`../PokerDom_Practice_App/AGENTS.md`. Read that first.
...
- `data/reference/*.csv` tables (`archetype_facing_bet.csv`,
  ...
  opponent-aware rules (see the sibling AGENTS.md's flag table).
...
Both of these are flagged in the sibling repo's AGENTS.md as the
...
AGENTS.md's GitHub section, don't trust it blindly, re-verify with
